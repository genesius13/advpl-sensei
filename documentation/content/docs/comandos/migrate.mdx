...
4. **Carregar skill** - Invocar skill `advpl-to-tlpp-migration` para regras e checklist
...
11. **Executar migracao** - Gerar arquivo(s) .tlpp seguindo o plano aprovado e skill `advpl-to-tlpp-migration`
